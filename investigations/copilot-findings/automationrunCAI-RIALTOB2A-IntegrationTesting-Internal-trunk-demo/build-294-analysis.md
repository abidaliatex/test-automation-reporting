...
Source report: [build-294.md](../../../reports/build-failures/automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo/build-294.md)

## Summary

- Build `automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo` #294 ended `UNSTABLE` with 3 failed tests out of 14.
...
- Failures are persistent since build #246 (`failedSince: 246`), indicating an unresolved regression.
