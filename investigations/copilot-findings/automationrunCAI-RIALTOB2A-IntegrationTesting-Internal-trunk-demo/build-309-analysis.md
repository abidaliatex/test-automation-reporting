# Root Cause Analysis — Build 309

**Job:** `automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo`  
**Report:** [build-309.md](../../../reports/build-failures/automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo/build-309.md)

---

## Summary

- Build 309 is `UNSTABLE` with 3 failed tests out of 15 (80.0% pass rate).
