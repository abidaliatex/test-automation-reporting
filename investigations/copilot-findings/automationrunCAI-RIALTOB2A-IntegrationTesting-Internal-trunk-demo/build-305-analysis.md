...
**Report:** [build-305.md](../../../reports/build-failures/automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo/build-305.md)

---

## Summary

- Build 305 is `UNSTABLE` with 3 failed tests out of 15 (80.0% pass rate).
- All failures are confined to `rialtoB2A(CASS TC29 Magazine (change to Uppslag/Spread/Panorama)`.
- The same failure pattern as builds 301, 303, and 304 persists: MediaHouse and Rialto responses do not match the TC29 expected original-state and reverted full-page values.
...
This recurring pattern across multiple consecutive builds (301, 303, 304, 305) points to stale TC29 expectation data or an incorrect assumption about the order state transitions rather than a transient environment issue.
