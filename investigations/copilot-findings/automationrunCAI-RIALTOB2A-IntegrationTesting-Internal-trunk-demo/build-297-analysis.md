# Root Cause Analysis — Build 297

**Job:** `automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo`  
**Report:** [build-297.md](../../../reports/build-failures/automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo/build-297.md)

---

## Summary

- Build 297 is `UNSTABLE` with 3 failed tests out of 14.
- All three failures are a continuation of the long-running regression in the TC4 Change Placement flow, present since at least build 246.
