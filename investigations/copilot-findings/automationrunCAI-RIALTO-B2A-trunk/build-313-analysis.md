...
**Source Report:** [build-313.md](../../reports/build-failures/automationrunCAI-RIALTO-B2A-trunk/build-313.md)

---

## Summary

Build 313 of `automationrunCAI-RIALTO-B2A-trunk` is UNSTABLE with 10 failures out of 17 tests (41.2% pass rate). All failures are confined to the `rialtoB2A(CASS)` suite. The failure pattern is identical to builds 306–312, indicating a persistent environment issue rather than a regression introduced in this run.
