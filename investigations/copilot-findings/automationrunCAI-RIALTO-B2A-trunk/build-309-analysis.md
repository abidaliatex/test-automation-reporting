# Build 309 Root Cause Analysis

Source report: [build-309.md](../../../reports/build-failures/automationrunCAI-RIALTO-B2A-trunk/build-309.md)

## Summary

- Build `automationrunCAI-RIALTO-B2A-trunk` #309 finished `UNSTABLE` with 10 failed tests out of 17 (pass rate 41.2%).
...
- This failure signature is identical to builds 305–308, indicating a persistent environment issue with CASS route availability.
...
- Track repeated identical failure signatures across consecutive builds (305–309 are identical) and alert on recurrence.
