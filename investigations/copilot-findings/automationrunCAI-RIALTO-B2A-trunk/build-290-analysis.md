# Build 290 Root Cause Analysis

Source report: [build-290.md](../../../reports/build-failures/automationrunCAI-RIALTO-B2A-trunk/build-290.md)

## Summary

- Build `automationrunCAI-RIALTO-B2A-trunk` #290 finished `UNSTABLE` with 10 failed tests out of 17.
...
- Jenkins checked out revision `4a04ddba1e4e5809017f1f7cf91b06e93e3c19dd` with commit message `updated api version from 87 to 88`, matching the same failure pattern already seen in builds 284–286.
