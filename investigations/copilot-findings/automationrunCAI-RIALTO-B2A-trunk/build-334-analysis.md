# Investigation — automationrunCAI-RIALTO-B2A-trunk #334

Source report: [build-334.md](../../../reports/build-failures/automationrunCAI-RIALTO-B2A-trunk/build-334.md)

---

## Build Summary

Build: `automationrunCAI-RIALTO-B2A-trunk` #334  
Total Tests: 17  
Passed: 7  
Failed: 10  
Pass Rate: 41.2%
...
- Build `automationrunCAI-RIALTO-B2A-trunk` #334 finished `UNSTABLE` with 10 failed tests out of 17.
...
- The Jenkins console header shows commit message `updated testcase29 data tc_getMHTC_MZN04a`, which does not directly match the failing RIALTO CASS scenarios.
