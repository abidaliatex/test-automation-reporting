# Investigation — automationrunCAI-RIALTO-B2A-trunk #347

Source report: [build-347.md](../../../reports/build-failures/automationrunCAI-RIALTO-B2A-trunk/build-347.md)

---

## Build Summary

Build: `automationrunCAI-RIALTO-B2A-trunk` #347  
Total Tests: 17  
Passed: 14  
Failed: 3  
Pass Rate: 82.4%
...
- Build #347 is unstable with 3 assertion failures in `rialtoB2A(CASS).feature`, all failing since build #231 (`failedSince: 231`, `age: 117`).

## Root Cause

- Expected test baselines do not align with current service output. All three failures are long-running regressions (age 117 builds).
