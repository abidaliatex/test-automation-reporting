...
Build: `automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo` #283  
Date: 2026-07-10 16:24 UTC  
Status: UNSTABLE  
Total Tests: 14  
Passed: 11  
Failed: 3  
...
### Rialto order state, commission, and depth not updated after MH placement change
...
**Failure Pattern:**
Rialto GET after the MH placement-change PATCH returns stale/incorrect `statusFlags`, `commissionAmount`, `depth`, and pricing fields — the placement update is not reflected in the Rialto order.
...
- `priceGross` expected `250000.00` found `250000.0` (decimal precision); `orderAdDetails[0].priceNet` expected `250000.00` found `249380.0`; `orderAdDetails[0].priceNetExComm` expected `250000.00` found `250000.0`.
- `orderHeader.priceNetExComm` expected `250000.00` found `250000.0`.
