...
Build: `automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo` #287  
Date: 2026-07-11 21:07:43 UTC  
Status: `UNSTABLE`  
Total Tests: 14  
Passed: 11  
Failed: 3  
...
**Failure Pattern:**
`orders[0].printDetails.discountType` and related basket totals/commission/VAT fields returned values different from MediaHouse assertions.
...
- `tc_getMHTC03a`: `discountType` expected `[NONE]` found `[RIALTO]`; `commission` expected `[7750.00]` found `[12500.00]`; `totalInclVat` expected `[302812.50]` found `[296875.00]`; `sum` expected `[242250.00]` found `[237500.00]`.
