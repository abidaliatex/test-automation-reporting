...
- Verify whether the API v88 change intentionally altered placement-change pricing fields before updating expectations.
- Re-check the expected values used by `getMHB2A.csv` and `getRialtoB2A.csv` for this flow against the build #262 responses.
