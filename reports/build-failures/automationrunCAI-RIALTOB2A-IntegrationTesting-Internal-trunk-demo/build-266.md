...
- These failures have persisted since build #246; investigate whether the placement-change flow regression is known and tracked.
- Verify expected values in `getMHB2A.csv` and `getRialtoB2A.csv` against current API responses for this flow.
