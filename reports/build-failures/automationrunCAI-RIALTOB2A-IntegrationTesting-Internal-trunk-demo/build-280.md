...
Build: `automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo` #280
Date: 2026-07-10 15:11 UTC
Status: UNSTABLE
Total Tests: 14
Passed: 11
Failed: 3
...
### MediaHouse post-placement pricing and discountType assertions diverge from expected values
...
### Rialto order state, commission, and depth assertions diverge after placement change
...
**Failure Pattern:**
Rialto GET after placement change returns empty `statusFlags`, severely reduced `commissionAmount`, wrong `depth`, and a slightly off `priceNet` compared to fixture expectations.
