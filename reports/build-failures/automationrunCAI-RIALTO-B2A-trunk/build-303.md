...
Build: `automationrunCAI-RIALTO-B2A-trunk` #303  
Date: 2026-07-11 14:58 UTC  
Status: UNSTABLE  
Total Tests: 17  
Passed: 7  
Failed: 10  
...
**Affected Scenarios:**
- User perform CASS POST API — update order (`tc_patchRialtoB2A01`)
- User perform CASS POST API — store status of order (`tc_getRialtoB2A05`)
- User perform CASS POST API — store status after update (`tc_getRialtoB2A06`)
