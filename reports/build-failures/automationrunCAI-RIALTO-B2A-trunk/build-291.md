...
Build: `automationrunCAI-RIALTO-B2A-trunk` #291  
Date: 2026-07-10 10:59 UTC  
Status: UNSTABLE  
Total Tests: 17  
Passed: 7  
Failed: 10  
...
- Jenkins checked out revision `4a04ddba1e4e5809017f1f7cf91b06e93e3c19dd` with commit `updated api version from 87 to 88`
...
**Failure Pattern:**
Dependent steps reused a `uuid` and JSON body from earlier order calls; once those prerequisite calls returned HTML 404 pages, follow-up requests failed with missing path parameters or JSON parsing errors.
