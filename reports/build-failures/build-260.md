# Build Failure Report — Build #260
...
| **Build URL** | https://crossadv.atex.com/jenkins/job/automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk-demo/260/ |
| **Branch** | `trunk` |
| **Status** | ⚠️ UNSTABLE |
...
- Confirm placement-change pricing/discount transformation rules between Rialto and MediaHouse in this environment.
- Re-run the single failed flow (`CASS TC4 Change Placement`) after validating expected commission/discount mappings.
- See investigation: [build-260-analysis.md](../../investigations/copilot-findings/build-260-analysis.md)
