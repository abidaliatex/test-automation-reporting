...
| Field | Value |
|---|---|
| **Build** | [183](https://crossadv.atex.com/jenkins/job/automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk/183/) |
| **Job** | automationrunCAI-RIALTOB2A-IntegrationTesting-Internal-trunk |
| **Date** | 2026-08-27 21:03:11 UTC |
| **Status** | UNSTABLE |
| **Duration** | ~94 min |
...
### Order line field/state mismatch — 45 failures across 20 TCs
...
- **Sample evidence:**
  ...
  - `Mismatch on field: orders.printDetails.plaCode expected [[TEXT, TEXT, TEXT, TEXT, TEXT, UPPSLAG]] but found [[TEXT, TEXT, TEXT, TEXT, TEXT, TEXT]]`
...
- **Error:** `Redundant path parameters are: agencyPrisaId=8238. Undefined path parameters are: uuid.`

### Integration ID mismatch — 1 failure

- **Affected TC:** TC35
- **Failing step:** `MEDIAHOUSE - Verify updated magazine order state in MediaHouse`
- **Error:** `MH basket ID (orBoxid) [8248] does not match Agency Prisa ID [8249]`
